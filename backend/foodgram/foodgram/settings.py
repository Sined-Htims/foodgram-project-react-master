...
SECRET_KEY = 'django-insecure-98!@c@znzd9(%7iqhn0j=@+#!4718_e@d6!j@b+haqiml0sd0^'
...
MIDDLEWARE = [
    ...
    'api.middleware.InterceptorIntegrityErrorMiddleware'
]
...
MAX_LENGTH_UNIT_INGREDIENT = 200
